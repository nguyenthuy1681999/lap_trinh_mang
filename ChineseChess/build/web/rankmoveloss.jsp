...
<title>Xếp hạng trung bình thua </title>
<style>
    * {
...
<ul>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="<%=request.getContextPath()%>/rankmoveloss">Trung bình nước đi thắng</a>
    </div>
  </li>
...
<div class="content">
    <h2>Bảng xếp trung bình số nước đi trận thua giảm dần</h2>
    <table id="players">
                    ...
                    <tbody>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Số trận thua</th>
                                <th>Tổng số nước đi trận thua</th>
                                <th>Trung bình số nước đi trận thua</th>
                                <th>Xem thông tin</th>
                            </tr>
                        </thead>
                        <c:forEach var="player" items="${listrankmoveloss}">    
                            <tr>
                                <td>
                               ...
                               <td>
                                ...
                                <td>
                                    <c:out value="${player.nuocdithua}" />
                                </td>
                                <td style="color: red">
                                    <c:out value="${player.trungbinhnuocdithua}" />
                                </td>
